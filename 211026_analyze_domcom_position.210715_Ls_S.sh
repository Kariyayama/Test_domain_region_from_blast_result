...
input="vertebrate"
inner_out="L_camtschaticum/211026_${animal}_${input}_inner_domcom.210715_Ls_S.tsv"
outer_out="L_camtschaticum/211026_${animal}_${input}_outer_domcom.210715_Ls_S.tsv"
inputfile="q_L_camtchaticum_vertebrate_class2_db_210715_Ls_S_Trinity.tsv"
